    ...
    "story": {
      "en": {
        ...
        "timeline": [
          ...
          {
            "year": "Vineyards",
            "label": "Hillside cultivation and retreat"
          },
          {
            "year": "Trnka",
            "label": "Creative memory enters the grounds"
          },
          {
            "year": "Prague 5",
            "label": "Urban energy gathers around the site"
          },
          {
            "year": "22 homes",
            "label": "Two boutique buildings take shape"
          },
          {
            "year": "Wellness",
            "label": "Pool, hammam, sauna, terrace"
          },
          {
            "year": "2026",
          ...
          {
            "year": "Beyond",
            "label": "A new chapter of private living"
          }
        ],
        "beats": [
          {
      ...
      "cs": {
        ...
        "timeline": [
          ...
          {
            "year": "Vinice",
            "label": "Svahové hospodaření a ústraní"
          },
          {
            "year": "Trnka",
            "label": "Do areálu vstupuje tvůrčí paměť"
          },
          {
            "year": "Praha 5",
            "label": "Městská energie obklopuje místo"
          },
          {
            "year": "22 domovů",
            "label": "Vznikají dvě butikové budovy"
          },
          {
            "year": "Wellness",
            "label": "Bazén, hammam, sauna, terasa"
          },
          {
            "year": "2026",
          ...
          {
            "year": "Dál",
            "label": "Nová kapitola soukromého bydlení"
          }
        ],
        "beats": [
          {
      ...
      "ru": {
        ...
        "hero": {
          ...
          "badges": [
            {
              "label": "XVIII в.",
              "note": "истоки поместья"
            },
            {
              "label": "22",
              "note": "частные резиденции"
            },
            {
              "label": "2026",
        ...
        "story": {
          ...
          "paragraphs": [
            ...
            "Это чувство избирательного уединения определяет философию проекта: городское поместье для резидентов, которые хотят, чтобы ритм Праги был рядом, но первым ощущением дома была тишина."
          ]
        },
        "pillars": [
          {
          ...
          },
          {
            ...
            "text": "Редкий адрес, определяемый уединением и сдержанностью, а не желанием впечатлить"
          },
          {
        ...
        "timeline": [
          {
            "year": "XVIII в.",
            "label": "Поместье Франтишека из Турбы"
          },
          {
            "year": "Виноградники",
            "label": "Возделывание склона и уединение"
          },
          {
            "year": "Трнка",
            "label": "Творческая память входит в территорию"
          },
          {
            "year": "Прага 5",
            "label": "Городская энергия собирается вокруг места"
          },
          {
            "year": "22 дома",
            "label": "Обретают форму два бутиковых здания"
          },
          {
            "year": "Велнес",
            "label": "Бассейн, хаммам, сауна, терраса"
          },
          {
            "year": "2026",
          ...
          {
            "year": "Далее",
            "label": "Новая глава частной жизни"
          }
        ],
        "beats": [
          {
            ...
            "paragraphs": [
              ...
              "Эта изначальная история важна. Turbová не изобретает уединение с нуля; она продолжает отношения между землёй и людьми, которых она притягивала."
            ],
            "points": [
              "Бывшее поместье XVIII века",
              "Избирательное уединение с самого начала",
          ...
          },
          {
            ...
            "paragraphs": [
              ...
              "Масштаб выбран намеренно. Turbová ведёт себя скорее как частное поместье, чем как обычная застройка, где именно камерность становится подлинным маркером статуса."
            ],
            "points": [
              "Всего 22 резиденции",
              "Дома 110–299 м²",
          ...
          },
          {
            ...
            "points": [
              ...
              "Сауна и хаммам",
              "Лаунж-терраса и частное угощение"
            ],
            "media": [
              {
                "src": "assets/images/pool-dark.webp",
          ...
          {
            "number": "06",
            "title": "Парк, превращающий престиж в уединение",
            "paragraphs": [
      ...
      "fr": {
        ...
        "hero": {
          ...
          "badges": [
            ...
            {
              "label": "22",
              "note": "résidences privées"
            },
            {
              "label": "2026",
              "note": "achèvement du projet"
            }
          ]
        },
        "metrics": [
        ...
        "timeline": [
          ...
          {
            "year": "Vignes",
            "label": "Culture du coteau et retraite"
          },
          {
            "year": "Trnka",
            "label": "La mémoire créative entre dans le domaine"
          },
          {
            "year": "Prague 5",
            "label": "L'énergie urbaine se rassemble autour du site"
          },
          {
            "year": "22 logements",
            "label": "Deux bâtiments boutique prennent forme"
          },
          {
            "year": "Bien-être",
            "label": "Piscine, hammam, sauna, terrasse"
          },
          {
            "year": "2026",
          ...
          {
            "year": "Au-delà",
            "label": "Un nouveau chapitre de vie privée"
          }
        ],
        "beats": [
          {
